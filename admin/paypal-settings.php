...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $success_message = "Configuración de PayPal guardada exitosamente";
}
...
foreach ($settingKeys as $key) {
    ...
    $currentSettings[$key] = $result ? $result['setting_value'] : '';
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Configuración PayPal - Admin</title>
        ...
        <header class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <a href="/manager" class="text-blue-600 hover:text-blue-800">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg shadow-md">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Configura tus credenciales de PayPal para procesar pagos</p>
                </div>
                ...
                <form method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="paypal_mode" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            <option value="sandbox" <?php echo $currentSettings['paypal_mode'] === 'sandbox' ? 'selected' : ''; ?>>
                                Sandbox (Pruebas)
                            </option>
                            <option value="live" <?php echo $currentSettings['paypal_mode'] === 'live' ? 'selected' : ''; ?>>
                                Live (Producción)
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo htmlspecialchars($currentSettings['paypal_merchant_id']); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
                    ...
                    <div>
                        ...
                        <input type="email" 
                               name="paypal_email" 
                               value="<?php echo htmlspecialchars($currentSettings['paypal_email']); ?>"
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t">
                        <a href="/manager" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                            Cancelar
                        </a>
