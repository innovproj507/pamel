    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="bg-cyan-600 px-6 py-4">
            <div class="flex items-center">
                ...
                <h2 class="text-2xl font-bold text-white"><?php echo __('shop.quote_success.title'); ?></h2>
            </div>
        </div>

        <div class="px-6 py-8">
            <p class="text-gray-700 text-lg mb-4">
                <?php echo __('shop.quote_success.message'); ?>
            </p>

            <div class="bg-cyan-50 border border-cyan-200 rounded-lg p-4 mb-6">
                <p class="text-sm text-cyan-800">
                    <?php echo __('shop.quote_success.email_conf'); ?>
                </p>
            </div>
